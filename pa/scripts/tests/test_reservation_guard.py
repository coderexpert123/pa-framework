...
class ReservationGuardTestCase(unittest.TestCase):
    def setUp(self):
        # .resolve() is load-bearing: on this machine the default TEMP is a link
        # (C:/Users/.../Temp -> D:/Users/.../Temp); mkdtemp returns the link
        # spelling, and the guard resolves every input path - an unresolved
        # REPO_ROOT then never contains any resolved input (8F/2E at the first
        # worktree push gate, 2026-08-24, default-TEMP only).
