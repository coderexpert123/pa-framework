...
// does this for the whole suite, but ONLY via the `--import` preload — and the
...
// workers.js or worker-exec.js — see that file's header for its known
// direct-imports-only limitation.
