...
{"verdict": "extend" | "kill", "summary": "...", "reason": "..."}
...
- "kill" if the agent is: repeating itself or looping (same thoughts/content reworded), producing no meaningful new output, or making a fundamental mistake it will not recover from
- "summary" must be a user-friendly 1-3 sentence description. For "kill": what was accomplished before it stalled. For "extend": what it is actively working on.
...
---`;
    ...
    if (parsed.verdict !== 'extend' && parsed.verdict !== 'kill') {
