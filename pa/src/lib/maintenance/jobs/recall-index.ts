...
export const recallIndexJob: MaintenanceJob = {
  ...
  everyMs: 10 * 60_000,
  description:
    'Incrementally refresh ~/.pa/recall.sqlite (FTS5) from conversation-history.jsonl + rotated shards, turn-traces.jsonl, topic brains, the Ecosystem KB and review-digest-pending.jsonl. Non-destructive: the DB is derived and rebuildable with `pa recall --rebuild`.',
  destructive: false,
