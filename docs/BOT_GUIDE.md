...
- `/model [name]` — view or override the active foundation model for the current agent (e.g. `/model gemini-3.7-flash-high`)
...
- **Model**: active underlying foundation model (e.g., `gemini-3.7-flash-high`, `opusplan`, etc.)
